"""Wrapper script for the output-layer anomaly chart script."""

from src.output.reports.show_anomalies import *  # noqa: F401,F403
...
plt.tight_layout()
plt.savefig("results/anomalies.png", dpi=150)
print("\nPlot saved to results/anomalies.png")
